...
public void onDrawFrame(GL10 gl) {
	...
	{
//		int time = (int) (SystemClock.uptimeMillis() % 7);
//		if(rand)
//			gl.glBindTexture(GL10.GL_TEXTURE_2D, sTextureIDWorkspace[i % 7]);
//		else
//			gl.glBindTexture(GL10.GL_TEXTURE_2D, sTextureIDWorkspace[time]);
//			
//		gl.glPushMatrix();
//		gl.glLoadIdentity();
//	
//		gl.glTranslatef(((i / 20) + 1) * SQUARE_WIDTH - (SQUARE_WIDTH / 2), ((i % 20) + 1) * SQUARE_HEIGHT - (SQUARE_HEIGHT / 2), 0);
